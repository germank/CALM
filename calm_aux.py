...
class SequenceIterator(object):
    def __init__(self, name, corpus, switching_points, chunk_size):
        ...
        self.total_data = sum(switching_points)
        self.corpus_data = corpus.get_data(int(self.total_data) * chunk_size + 1)
...
class RandomAlternationIterator(object):
    ...
    def __len__(self):
        return sum(c.get_total_data() for c in self.collections)
